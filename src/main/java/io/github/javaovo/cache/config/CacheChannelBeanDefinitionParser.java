...
public class CacheChannelBeanDefinitionParser extends AbstractBeanDefinitionParser {
	...
	protected AbstractBeanDefinition parseInternal(Element element, ParserContext parserContext) {
		BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(RaeCacheFactoryBean.class);
		setCacheChannelHome(element, builder);
		return getSourcedBeanDefinition(builder, element, parserContext);
	}

	private void setCacheChannelHome(Element element, BeanDefinitionBuilder builder) {
		builder.addPropertyValue("L1", element.getAttribute("L1"));
		builder.addPropertyValue("L2", element.getAttribute("L2"));
