 ...
 * @Date: 2018-10-07 21:44:56
 * @Since: 1.0
 */
public class SingleRedisClient implements RaeRedisClient<String, Object> {
	...
	public SingleRedisClient(Redis4ClientConfig config, RedisURI redisURI, String ns) {
		if (redisURI == null) {
			return;
		}
		this.ns = ns;
